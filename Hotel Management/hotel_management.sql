...
INSERT INTO `customer` (`customer_id`, `cus_name`, `reservation_date`, `no_days`) VALUES
(1, 'Shahrukh Khan', '2020-08-01', 4),
(2, 'Timothee Chalamet', '2020-08-17', 2),
(3, 'Saif Hmadare', '2020-08-20', 10),
(4, 'Christiano Ronaldo', '2020-08-16', 5),
(5, 'Pooja Chauhan', '2020-08-26', 10),
(6, 'Muskan Kazi', '2020-08-25', 5),
(7, 'Zendaya', '2020-08-25', 5),
(8, 'Talha Fakih', '2020-08-25', 5),
(9, 'Bhagyashree Chaudhary', '2020-08-30', 3);
...
--
ALTER TABLE `bill`
  MODIFY `bill_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
